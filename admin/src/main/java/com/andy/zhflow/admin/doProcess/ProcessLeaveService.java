...
import com.andy.zhflow.flow.config.utils.BpmnModelUtil;
...
@Component
public class ProcessLeaveService extends DoProcessService {
    ...
    public List<ApprovalProcessDiagramOutputItemVO> getApprovalProcessDiagramData(String taskId) throws Exception {
        List<ApprovalProcessDiagramOutputItemVO> list=new ArrayList<>();
        ...
        for (int i = 0; i < flowList.size(); i++) {
            ...
            ApprovalProcessDiagramOutputItemVO itemVO=new ApprovalProcessDiagramOutputItemVO();
